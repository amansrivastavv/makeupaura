...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 h-full container px-6 md:px-20 flex flex-col justify-end pb-24 md:pb-32">
            <motion.div
            ...
            >
                ...
                <p className="max-w-xl text-base md:text-lg text-white/80 mb-8 md:mb-10 font-sans leading-relaxed text-shadow-sm">
                    India’s premier platform for booking high-end makeup artists. 
                    Bridal, editorial, and special events curated for you.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                    <Button size="lg" variant="primary">Explore Artists</Button>
